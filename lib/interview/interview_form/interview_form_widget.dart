          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator:
                    _model.quoteInputControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    height: 50.0,
                    decoration: BoxDecoration(
                      color: FlutterFlowTheme.of(context).notActiveBtn,
                      shape: BoxShape.circle,
                    ),
                    child: Visibility(
                      visible: widget.feedInterviewRow?.imageUrl != null &&
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      final selectedMedia =
                        ...
                        context: context,
                        storageFolderPath: 'admin_panel/media/image',
                        maxWidth: 650.00,
                        maxHeight: 650.00,
                        imageQuality: 80,
                        allowPhoto: true,
                      ...
                      setState(() {
                        _model.imageUploadedPath = _model.uploadedFileUrl;
                      });
                    },
                    child: wrapWithModel(
              ...
              child: InkWell(
                  ...
                  if ((_model.interviewHeroInputController.text != null &&
                    ...
                    if (widget.feedInterviewRow != null) {
                      ...
                      await FeedInterviewTable().insert({
                        'interview_hero':
                            _model.interviewHeroInputController.text,
                        'introduction': _model.introductionInputController.text,
                        'speciality': _model.specialityInputController.text,
                        'quote': _model.quoteInputController.text,
                        'image_url': _model.imageUploadedPath,
                        'main_part': _model.mainPartFieldController.text,
                ...
                child: wrapWithModel(
                  ...
                  child: ButtonWidget(
                    ...
                    isActive: (_model.interviewHeroInputController.text !=
                                null &&
                            _model.interviewHeroInputController.text != '') &&
                        (_model.specialityInputController.text != null &&
                            _model.specialityInputController.text != '') &&
