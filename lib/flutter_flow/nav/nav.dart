...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LoginAccessCheckWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? LoginAccessCheckWidget()
              : LoginWidget(),
        ),
        FFRoute(
          name: 'HomePage',
        ...
        FFRoute(
          name: 'LoginAccessCheck',
          path: '/loginAccessCheck',
          builder: (context, params) => LoginAccessCheckWidget(),
        ),
        FFRoute(
          name: 'Schools',
          path: '/schools',
